 ...
 */
const PromptFieldRecord = exports.PromptFieldRecord = (0, _forwardRef.forwardRef)(function PromptFieldRecord(props, ref) {
  const {
      render,
      className,
      onClick
  ...
  const recognition = (0, _useLazyRef.default)(() => {
    if (!_speechRecognition.BrowserSpeechRecognition) {
      return {
        start: () => {},
        abort: () => {}
      };
    ...
    const instance = new _speechRecognition.BrowserSpeechRecognition();
