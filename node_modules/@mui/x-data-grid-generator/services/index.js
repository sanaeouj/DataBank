...
var _promptResolver = require("./prompt-resolver");
Object.keys(_promptResolver).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _promptResolver[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _promptResolver[key];
    }
  });
});